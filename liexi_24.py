...
class MainApplication:
    ...
    def load_ai_model(self):
        ...
        try:
            # 更改模型路径为U-Net++模型
            model_path = "unet_crack_24.h5"  # 新的模型文件名
            if not os.path.exists(model_path):
                model_path = "unet_crack_final24.h5"  # 备选路径
    ...
    def create_left_workspace(self, parent):
        ...
        self.threshold_slider = ttk.Scale(
            ...
            value=0.7, orient='horizontal', length=200
        )
    ...
    def analyze_cracks(self):
        ...
        try:
            ...
            for item in self.crack_data:
                ...
                # 绘制裂隙线条
                cv2.polylines(processed_img, [pts], False, (255, 0, 0), 1)
